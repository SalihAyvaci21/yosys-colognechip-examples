...
:: ----------------------------
set TOP=led_bounce_up_down_counter
set VLOG_SRC=src\led_bounce_up_down_counter.v src\debounce_ip_core.v 
set LOG=0
...
if "%1"=="sim_vlog" (
    "%IVL%" -o sim\iverilog\%TOP%_sim.vvp sim\iverilog\%TOP%_tb.v src\%TOP%.v src\debounce_ip_core.v
