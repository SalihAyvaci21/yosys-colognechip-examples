...
:: ----------------------------
set TOP=full_adder
set VLOG_SRC=src/shift_register_9bit.v src/shift_register_8bit.v src/SerialAdderTop.v src/Fulladder.v src/Full_Adder_SR_FSM.v src/Full_Adder_SR.v src/control_fsm.v
set VHDL_SRC=
set LOG=0
